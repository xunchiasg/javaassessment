...
//Java Assessment - Course Service//
...
public class CourseService
{
    ...
    //Constructor with values for students and courses (Within Course.java)
    ...
    //Assignment IF STATEMENT to enroll student
    ...
    //Method for returning course
    public Course getCourse(String courseId){
        return courses.get(courseId);
    }

    //Method to show (print) summary
